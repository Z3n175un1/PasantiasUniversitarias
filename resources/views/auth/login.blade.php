    ...
    <main class="w-full max-w-[480px] animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <section class="bg-white rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100 p-8 md:p-12">
            ...
            <header class="text-center mb-10 space-y-3">
                <a href="index.html" class="inline-flex items-center gap-2 group cursor-pointer mb-2">
            ...
            <footer class="mt-10 text-center space-y-6">
                <p class="text-sm font-semibold text-gray-500" id="footer-link">
                    ¿Eres nuevo? 
                    <a href="registro.html" class="text-[#0d121f] font-black border-b-2 border-blue-100 hover:border-[#2b6df2] transition-all ml-1">Crea una cuenta</a>
                </p>
        ...
        <div class="mt-8 text-center">
            <a href="index.html" class="inline-flex items-center gap-2 text-xs font-bold text-gray-400 hover:text-[#0d121f] transition-colors uppercase tracking-wider">
