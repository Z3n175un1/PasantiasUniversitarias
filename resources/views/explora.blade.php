                               ...
                               data-modalidad="{{ $oferta->modalidad ?? 'Presencial' }}">
                                <div>
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        @endif
                                        @if($oferta->vacantes_disponibles && $oferta->vacantes_disponibles > 1)
                                            <div class="flex items-center gap-1.5 px-3 py-1 bg-amber-50 rounded-lg text-xs font-semibold text-amber-600">
                                                <i data-lucide="users" class="w-3.5 h-3.5"></i>
                                                <span>{{ $oferta->vacantes_disponibles }} vacantes</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="flex items-center justify-between pt-4 mt-4 border-t border-slate-100">
                                    <span class="text-xs font-bold text-slate-400">
                                        ...
                                        @if($oferta->duracion_semanas) • {{ $oferta->duracion_semanas }} sem. @endif
                                    </span>
