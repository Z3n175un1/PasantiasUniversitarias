        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <aside class="lg:w-64 flex flex-col gap-2">
                ...
                <button data-tab="postulaciones"
                    ...
                    Mis Postulaciones
                    <span
                        class="ml-auto bg-slate-200 text-slate-700 text-xs px-2 py-0.5 rounded-full font-bold">2</span>
                </button>
                ...
                <button data-tab="entrevistas"
                    class="tab-btn flex items-center gap-3 px-5 py-3.5 text-slate-600 hover:bg-slate-100 font-semibold rounded-2xl transition-all text-left text-sm w-full">
                    <i data-lucide="calendar" class="w-5 h-5"></i>
                    Entrevistas
                    <span
                        class="ml-auto bg-amber-100 text-amber-800 text-xs px-2 py-0.5 rounded-full font-bold">1</span>
                </button>
                <div class="h-px bg-slate-200 my-4"></div>
                <a href="explora"
                    class="flex items-center gap-3 px-5 py-3.5 text-blue-600 hover:bg-blue-50 font-bold rounded-2xl transition-all text-sm">
            ...
            <div class="flex-1">
                ...
                <section id="inicio" class="tab-content active space-y-8">
                    <div
                        ...
                        <div>
                            <h1 class="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">¡Hola de nuevo,
                                Juan! 👋</h1>
                        ...
                        <div class="flex items-center gap-3 bg-blue-50/60 p-4 rounded-2xl border border-blue-100/50">
                            <div
                                ...
                                75%</div>
                            <div>
                                <h4 class="text-xs font-extrabold text-slate-400 uppercase tracking-wider">Perfil
                                    Completado</h4>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div
                            ...
                            <div class="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center">
                                <i data-lucide="send" class="w-6 h-6"></i></div>
                            <div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <i data-lucide="sparkles" class="w-6 h-6"></i></div>
                            <div>
                        ...
                        <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm space-y-4">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                                    ...
                                    <span class="px-3 py-1 bg-amber-50 text-amber-700 font-bold rounded-full text-xs">En
                                        Revisión</span>
                                </div>
                                <div class="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                                    <div>
                                        <h4 class="text-sm font-bold text-slate-900">Pasante de Inteligencia Artificial
                                        </h4>
                                        <p class="text-xs text-slate-500 font-medium">DataFlow Solutions • Santa Cruz
                                        </p>
                                    </div>
                                    <span
                                        class="px-3 py-1 bg-blue-50 text-blue-700 font-bold rounded-full text-xs">Entrevista</span>
                                </div>
                            </div>
                        </div>

                        <div
                            class="bg-gradient-to-br from-slate-900 to-slate-800 p-6 rounded-[2rem] text-white space-y-4 flex flex-col justify-between">
                            <div>
                                <div
                                    class="flex items-center gap-2 text-blue-400 font-extrabold uppercase text-xs tracking-wider">
                                ...
                                <p class="text-sm text-slate-300 mt-2 leading-relaxed">Detectamos que la empresa
                                    <b>SoftBol</b> está buscando pasantes con conocimientos en <b>Docker</b>. Agrega
                                    esta habilidad a tu perfil para subir tu match de un 88% a un 95%.</p>
                            </div>
                            <button
                                class="w-full py-3 bg-blue-600 text-white rounded-xl font-bold text-sm hover:bg-blue-700 transition active:scale-95">Actualizar
                                Perfil Ahora</button>
                        </div>
                    </div>
                </section>
                ...
                <section id="postulations" class="tab-content space-y-6">
                    ...
                    <div class="space-y-4">
                        <div
                            class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-12 h-12 bg-purple-50 text-purple-600 rounded-xl flex items-center justify-center">
                                    <i data-lucide="database" class="w-6 h-6"></i></div>
                                <div>
                                    <h3 class="font-bold text-slate-900">Pasante de Inteligencia Artificial</h3>
                                    <p class="text-xs text-slate-400 font-bold">DataFlow Solutions • <span
                                            class="text-blue-600">Santa Cruz (Presencial)</span></p>
                                </div>
                            </div>
                            <div class="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end">
                                <span
                                    class="px-3 py-1 bg-blue-50 text-blue-700 font-bold rounded-full text-xs">Entrevista
                                    Agendada</span>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 font-bold">SoftBol • <span
                                            class="text-green-600">La Paz (Virtual)</span></p>
                                </div>
                            </div>
                            <div class="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end">
                                <span class="px-3 py-1 bg-amber-50 text-amber-700 font-bold rounded-full text-xs">En
                                    Revisión por RRHH</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm space-y-4">
                            <div class="flex items-start justify-between">
                                <div
                                    ...
                                    <i data-lucide="file-text" class="w-6 h-6"></i></div>
                                <span
                                    class="text-[10px] bg-green-50 text-green-700 font-extrabold px-2 py-0.5 rounded-md uppercase tracking-wider">Verificado
                                    por Universidad</span>
                            </div>
                            <div>
                            ...
                            <div class="flex gap-2 pt-2">
                                <button
                                    class="flex-1 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-bold text-xs transition">Reemplazar</button>
                                <button
                                    class="p-2 bg-slate-50 text-slate-500 rounded-xl border border-slate-200 hover:bg-slate-100"><i
                        ...
                        <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm space-y-4">
                            <div class="flex items-start justify-between">
                                <div
                                    class="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center">
                                    <i data-lucide="file-badge" class="w-6 h-6"></i></div>
                                <span
                                    class="text-[10px] bg-amber-50 text-amber-700 font-extrabold px-2 py-0.5 rounded-md uppercase tracking-wider">Pendiente
                                    de Firma</span>
                            </div>
                            <div>
                            ...
                            <div class="flex gap-2 pt-2">
                                <button
                                    class="flex-1 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-xs transition">Subir
                                    Documento</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="text-sm font-medium text-slate-700 divide-y divide-slate-50">
                                <tr>
                                    ...
                                    <td class="p-5">28 Mayo, 2026<br><span class="text-xs text-blue-600 font-bold">14:30
                                            (Hora Bolivia)</span></td>
                                    <td class="p-5">
                                        <span
                                            class="inline-block px-2 py-0.5 bg-green-50 text-green-700 font-bold rounded text-xs">Virtual</span>
                                    </td>
                                    <td class="p-5 text-right">
                                        <button
                                            class="px-4 py-2 bg-[#0d121f] hover:bg-slate-800 text-white font-bold rounded-xl text-xs transition">Ingresar
                                            al Meet</button>
                                    </td>
                                </tr>
                            </tbody>
